...
(defrule r001-fact-exists
    ...
    (assert (sendmessage (str-cat "Рацион состоит из завтрака, обеда и ужина" ?newcf)))
)
...
(defrule r002-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Завтрак состоит из закуски" ?newcf)))
)
...
(defrule r003-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0 ?cf1 ?cf2)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Обед состоит из супа, основного блюда и напитка" ?newcf)))
)
...
(defrule r004-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0 ?cf1 ?cf2)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Ужин состоит из основного блюда, напитка и десерта" ?newcf)))
)
...
(defrule r005-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Мясо из говядины" ?newcf)))
)
...
(defrule r006-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Мясо из свинины" ?newcf)))
)
...
(defrule r007-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Мясо из баранины" ?newcf)))
)
...
(defrule r008-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Мясо из курицы" ?newcf)))
)
...
(defrule r009-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Мясо из крольчатины" ?newcf)))
)
...
(defrule r010-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рыба из красной рыбы" ?newcf)))
)
...
(defrule r011-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рыба из белой рыбы" ?newcf)))
)
...
(defrule r012-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареное мясо из мяса на сковороде" ?newcf)))
)
...
(defrule r013-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареная рыба из рыбы на сковороде" ?newcf)))
)
...
(defrule r014-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареное яйцо из яйца на сковороде" ?newcf)))
)
...
(defrule r015-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.8 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареная курица из сырой курицы на сковороде" ?newcf)))
)
...
(defrule r016-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареная курица из сырой курицы в печи" ?newcf)))
)
...
(defrule r017-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареное куриное филе из жареной курицы" ?newcf)))
)
...
(defrule r018-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Капустный лист из капусты" ?newcf)))
)
...
(defrule r019-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.7 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Говяжья котлета из говяжьего фарша на сковороде" ?newcf)))
)
...
(defrule r020-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Говяжий фарш из говядины" ?newcf)))
)
...
(defrule r021-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареный бекон из сырого бекона на сковороде" ?newcf)))
)
...
(defrule r022-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.7 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареный бекон из сырого бекона в печи" ?newcf)))
)
...
(defrule r023-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Сырой бекон из сырой свинины" ?newcf)))
)
...
(defrule r024-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареные кусочки баранины из жареной баранины" ?newcf)))
)
...
(defrule r025-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.8 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареные кусочки баранины из кусочков сырой баранины и печки" ?newcf)))
)
...
(defrule r026-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Кусочки баранины из баранины" ?newcf)))
)
...
(defrule r027-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.6 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареная баранина из баранины на сковороде" ?newcf)))
)
...
(defrule r028-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.7 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареная баранина из баранины в печи" ?newcf)))
)
...
(defrule r029-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареная крольчатина из крольчатины на сковороде" ?newcf)))
)
...
(defrule r030-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.6 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареная крольчатина из крольчатины в печи" ?newcf)))
)
...
(defrule r031-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.7 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Тесто из муки и воды" ?newcf)))
)
...
(defrule r032-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.7 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Тесто из муки и яйца" ?newcf)))
)
...
(defrule r033-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Печёный картофель из картофеля в печи" ?newcf)))
)
...
(defrule r034-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.8 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Печёный картофель из картофеля на сковороде" ?newcf)))
)
...
(defrule r035-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Ломтик красной рыбы из красной рыбы" ?newcf)))
)
...
(defrule r036-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Ломтик белой рыбы из белой рыбы" ?newcf)))
)
...
(defrule r037-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Куриное филе из курицы" ?newcf)))
)
...
(defrule r038-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.5 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Томатный соус из томатов в кастрюле" ?newcf)))
)
...
(defrule r039-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Сырая паста из теста" ?newcf)))
)
...
(defrule r040-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.6 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Стейк из говядины на сковороде" ?newcf)))
)
...
(defrule r041-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Запечённая ветчина из ветчины на сковороде" ?newcf)))
)
...
(defrule r042-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.8 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Запечённая ветчина из ветчины в печи" ?newcf)))
)
...
(defrule r043-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.6 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Основа для пирога из воды и муки" ?newcf)))
)
...
(defrule r044-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.65 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Основа для пирога из молока и муки" ?newcf)))
)
...
(defrule r045-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Шашлычок на шпажке из жареной курицы, лука и томата" ?newcf)))
)
...
(defrule r046-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Шашлычок на шпажке это закуска" ?newcf)))
)
...
(defrule r047-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Сэндвич с яйцом из хлеба и жареного яйца" ?newcf)))
)
...
(defrule r048-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Сэндвич с яйцом это закуска" ?newcf)))
)
...
(defrule r049-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Сэндвич с курицей из хлеба, листа капусты, жареного куриного филе и моркови" ?newcf)))
)
...
(defrule r050-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Сэндвич с курицей это закуска" ?newcf)))
)
...
(defrule r051-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Гамбургер из хлеба, говяжьей котлеты, томата, лука и листа капусты" ?newcf)))
)
...
(defrule r052-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Гамбургер это основное блюдо" ?newcf)))
)
...
(defrule r053-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.95 (min ?cf0 ?cf1 ?cf2 ?cf3)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Сэндвич с беконом из хлеба, жареного бекона, томата и листа капусты" ?newcf)))
)
...
(defrule r054-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Сэндвич с беконом это закуска" ?newcf)))
)
...
(defrule r055-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Шаурма из хлеба, лука, листа капусты и кусочков жареной баранины" ?newcf)))
)
...
(defrule r056-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Шаурма это основное блюдо" ?newcf)))
)
...
(defrule r057-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Шаурма это закуска" ?newcf)))
)
...
(defrule r058-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Пельмени из теста, лука и мяса" ?newcf)))
)
...
(defrule r059-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Пельмени из теста, лука и шампиньонов" ?newcf)))
)
...
(defrule r060-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Пельмени это основное блюдо" ?newcf)))
)
...
(defrule r061-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Картофельные лодочки из печёного картофеля, говяжьей котлеты и молока" ?newcf)))
)
...
(defrule r062-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Картофельные лодочки это основное блюдо" ?newcf)))
)
...
(defrule r063-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Голубцы в кастрюле из капусты с мясом, яйцом и луком" ?newcf)))
)
...
(defrule r064-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Голубцы в кастрюле из капусты с мясом и морковью" ?newcf)))
)
...
(defrule r065-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.7 (min ?cf0 ?cf1 ?cf2 ?cf3)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Голубцы в кастрюле из капусты с мясом и грибами" ?newcf)))
)
...
(defrule r066-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Голубцы это основное блюдо" ?newcf)))
)
...
(defrule r067-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.5 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Суши с красной рыбой из ломтика красной рыбы и варёного риса" ?newcf)))
)
...
(defrule r068-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Суши с красной рыбой это закуска" ?newcf)))
)
...
(defrule r069-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.5 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Суши с белой рыбой из ломтика белой рыбы и варёного риса" ?newcf)))
)
...
(defrule r070-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Суши с белой рыбой это закуска" ?newcf)))
)
...
(defrule r071-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Ролл из моркови, варёного риса и листа нори" ?newcf)))
)
...
(defrule r072-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Ролл это закуска" ?newcf)))
)
...
(defrule r073-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.9 (min ?cf0 ?cf1 ?cf2)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Фруктовый салат из ягод, яблока и долек арбуза" ?newcf)))
)
...
(defrule r074-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.9 (min ?cf0 ?cf1 ?cf2)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Фруктовый салат из ягод, яблока, долек тыквы" ?newcf)))
)
...
(defrule r075-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Фруктовый салат это десерт" ?newcf)))
)
...
(defrule r076-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.9 (min ?cf0 ?cf1 ?cf2)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Овощной салат из томата, листа капусты и свёклы" ?newcf)))
)
...
(defrule r077-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.9 (min ?cf0 ?cf1 ?cf2)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Овощной салат из томата, листа капусты и моркови" ?newcf)))
)
...
(defrule r078-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.9 (min ?cf0 ?cf1 ?cf2)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Овощной салат из томата, листа капусты и лука" ?newcf)))
)
...
(defrule r079-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Овощной салат это закуска" ?newcf)))
)
...
(defrule r080-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Грибной салат из шампиньона и листа капусты" ?newcf)))
)
...
(defrule r081-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Грибной салат это закуска" ?newcf)))
)
...
(defrule r082-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.8 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Варёный рис в кастрюле из риса" ?newcf)))
)
...
(defrule r083-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рагу из говядины в кастрюле из говяжьего фарша, моркови и картофеля" ?newcf)))
)
...
(defrule r084-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рагу из говядины это суп" ?newcf)))
)
...
(defrule r085-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Куриный суп в кастрюле из моркови, лука, капусты и куриного филе" ?newcf)))
)
...
(defrule r086-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Куриный суп это суп" ?newcf)))
)
...
(defrule r087-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Овощной суп в кастрюле из свёклы, картофеля, томата и капусты" ?newcf)))
)
...
(defrule r088-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.7 (min ?cf0 ?cf1 ?cf2 ?cf3 ?cf4)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Овощной суп в кастрюле из свёклы, картофеля, лука и капусты" ?newcf)))
)
...
(defrule r089-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.7 (min ?cf0 ?cf1 ?cf2 ?cf3 ?cf4)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Овощной суп в кастрюле из свёклы, картофеля, томата и моркови" ?newcf)))
)
...
(defrule r090-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.7 (min ?cf0 ?cf1 ?cf2 ?cf3 ?cf4)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Овощной суп в кастрюле из свёклы, картофеля, лука и моркови" ?newcf)))
)
...
(defrule r091-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Овощной суп это суп" ?newcf)))
)
...
(defrule r092-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рыбное томатное рагу в кастрюле из рыбы, томатного соуса и лука" ?newcf)))
)
...
(defrule r093-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рыбное томатное рагу это суп" ?newcf)))
)
...
(defrule r094-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.7 (min ?cf0 ?cf1 ?cf2 ?cf3 ?cf4)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареный рис с яйцом на сковороде из риса, яйца, лука и моркови" ?newcf)))
)
...
(defrule r095-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареный рис с яйцом это основное блюдо" ?newcf)))
)
...
(defrule r096-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Тыквенный суп в кастрюле из тыквы, молока, капусты и свинины" ?newcf)))
)
...
(defrule r097-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Тыквенный суп это суп" ?newcf)))
)
...
(defrule r098-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Уха в кастрюле из ломтиков сырой белой рыбы, томатов, яйца и картофеля" ?newcf)))
)
...
(defrule r099-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.5 (min ?cf0 ?cf1 ?cf2 ?cf3 ?cf4)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Уха в кастрюле из ломтиков сырой белой рыбы, лука, яйца и картофеля" ?newcf)))
)
...
(defrule r100-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Уха это суп" ?newcf)))
)
...
(defrule r101-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.6 (min ?cf0 ?cf1 ?cf2 ?cf3 ?cf4)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рамен в кастрюле из жареного яйца, сырой пасты, листа нори и говядины" ?newcf)))
)
...
(defrule r102-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.6 (min ?cf0 ?cf1 ?cf2 ?cf3 ?cf4)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рамен в кастрюле из жареного яйца, сырой пасты, листа нори и свинины" ?newcf)))
)
...
(defrule r103-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.6 (min ?cf0 ?cf1 ?cf2 ?cf3 ?cf4)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рамен в кастрюле из жареного яйца, сырой пасты, листа нори и баранины" ?newcf)))
)
...
(defrule r104-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.6 (min ?cf0 ?cf1 ?cf2 ?cf3 ?cf4)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рамен в кастрюле из жареного яйца, сырой пасты, листа нори и курицы" ?newcf)))
)
...
(defrule r105-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рамен это суп" ?newcf)))
)
...
(defrule r106-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.85 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Яичница с беконом из жареного яйца и жареного бекона" ?newcf)))
)
...
(defrule r107-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Яичница с беконом это закуска" ?newcf)))
)
...
(defrule r108-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Спагетти с фрикадельками на сковороде из говяжьего фарша, томатного соуса и сырой пасты" ?newcf)))
)
...
(defrule r109-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Спагетти с фрикадельками это основное блюдо" ?newcf)))
)
...
(defrule r110-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Спагетти с бараниной на сковороде из кусочков баранины, томатного соуса и сырой пасты" ?newcf)))
)
...
(defrule r111-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Спагетти с бараниной это основное блюдо" ?newcf)))
)
...
(defrule r112-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рис с грибами в кастрюле из шампиньонов, риса и моркови" ?newcf)))
)
...
(defrule r113-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.77 (min ?cf0 ?cf1 ?cf2 ?cf3)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рис с грибами в кастрюле из шампиньонов, риса и картофеля" ?newcf)))
)
...
(defrule r114-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рис с грибами это основное блюдо" ?newcf)))
)
...
(defrule r115-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареные бараньи ребрышки с рисом из жареных кусочков баранины, томатов, свёклы и варёного риса" ?newcf)))
)
...
(defrule r116-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жареные бараньи ребрышки с рисом это основное блюдо" ?newcf)))
)
...
(defrule r117-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рагу из крольчатины в кастрюле из крольчатины, шампиньона, картофеля и моркови" ?newcf)))
)
...
(defrule r118-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.4 (min ?cf0 ?cf1 ?cf2 ?cf3 ?cf4)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рагу из крольчатины в кастрюле из крольчатины, шампиньона, картофеля и томата" ?newcf)))
)
...
(defrule r119-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рагу из крольчатины это суп" ?newcf)))
)
...
(defrule r120-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Паста с овощами в кастрюле из сырой пасты, моркови, шампиньонов, листа капусты и томата" ?newcf)))
)
...
(defrule r121-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.7 (min ?cf0 ?cf1 ?cf2 ?cf3 ?cf4 ?cf5 ?cf6)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Паста с овощами в кастрюле из сырой пасты, моркови, шампиньонов, листа капусты и лука" ?newcf)))
)
...
(defrule r122-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Паста с овощами это основное блюдо" ?newcf)))
)
...
(defrule r123-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Стейк с картофелем из стейка, варёного риса, печёного картофеля и лука" ?newcf)))
)
...
(defrule r124-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Стейк с картофелем это основное блюдо" ?newcf)))
)
...
(defrule r125-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рататуй в кастрюле из свёклы, томатов, лука и моркови" ?newcf)))
)
...
(defrule r126-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Рататуй это основное блюдо" ?newcf)))
)
...
(defrule r127-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.4 (min ?cf0 ?cf1 ?cf2 ?cf3 ?cf4)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Чёрная паста с чернилами каракатицы в кастрюле из сырой пасты, чернил каракатицы, томатов и рыбы" ?newcf)))
)
...
(defrule r128-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Чёрная паста с чернилами каракатицы это основное блюдо" ?newcf)))
)
...
(defrule r129-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Красная рыба на гриле в сковороде из ломтиков красной рыбы, ягод и лука" ?newcf)))
)
...
(defrule r130-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Красная рыба на гриле это основное блюдо" ?newcf)))
)
...
(defrule r131-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жаркое из курицы из жареной курицы, лука, яйца, хлеба, моркови, картофеля" ?newcf)))
)
...
(defrule r132-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.68 (min ?cf0 ?cf1 ?cf2 ?cf3 ?cf4 ?cf5)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жаркое из курицы из жареной курицы, лука, яйца, хлеба, томата, картофеля" ?newcf)))
)
...
(defrule r133-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Жаркое из курицы это основное блюдо" ?newcf)))
)
...
(defrule r134-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Запеченная тыква в печи из тыквы, варёного риса, моркови и томата" ?newcf)))
)
...
(defrule r135-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Запечённая тыква это основное блюдо" ?newcf)))
)
...
(defrule r136-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Ветчина в медовом соусе с рисом из запечённой ветчины, ягод, мёда и варёного риса" ?newcf)))
)
...
(defrule r137-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Ветчина в медовом соусе с рисом это основное блюдо" ?newcf)))
)
...
(defrule r138-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.6 (min ?cf0 ?cf1 ?cf2 ?cf3 ?cf4)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Пастуший пирог в печи из молока, жареной баранины, лука, печёного картофеля" ?newcf)))
)
...
(defrule r139-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Пастуший пирог это основное блюдо" ?newcf)))
)
...
(defrule r140-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Пастуший пирог это закуска" ?newcf)))
)
...
(defrule r141-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0 ?cf1 ?cf2)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Сет роллов из суши с красной рыбой, суши с белой рыбой и роллов" ?newcf)))
)
...
(defrule r142-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Сет роллов это основное блюдо" ?newcf)))
)
...
(defrule r143-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Яблочный пирог в печи из муки, яблок, сахара и основы для пирога" ?newcf)))
)
...
(defrule r144-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Яблочный пирог это десерт" ?newcf)))
)
...
(defrule r145-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.7 (min ?cf0 ?cf1 ?cf2 ?cf3)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Чизкейк с ягодами в печи из ягод, молока и основы для пирога" ?newcf)))
)
...
(defrule r146-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Чизкейк с ягодами это десерт" ?newcf)))
)
...
(defrule r147-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.75 (min ?cf0 ?cf1 ?cf2 ?cf3 ?cf4)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Шоколадный пирог в печи из какао, молока, сахара и основы для пирога" ?newcf)))
)
...
(defrule r148-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Шоколадный пирог это десерт" ?newcf)))
)
...
(defrule r149-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Медовое печенье в печи из мёда и теста" ?newcf)))
)
...
(defrule r150-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Медовое печенье это десерт" ?newcf)))
)
...
(defrule r151-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.77 (min ?cf0 ?cf1 ?cf2 ?cf3)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Ягодное печенье в печи из ягод, сахара и теста" ?newcf)))
)
...
(defrule r152-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Ягодное печенье это десерт" ?newcf)))
)
...
(defrule r153-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.5 (min ?cf0 ?cf1 ?cf2 ?cf3 ?cf4)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Ягодный сорбет в кастрюле из ягод, молока, яйца и сахара" ?newcf)))
)
...
(defrule r154-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Ягодный сорбет это десерт" ?newcf)))
)
...
(defrule r155-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Арбузное мороженое из воды, арбуза и сахара" ?newcf)))
)
...
(defrule r156-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Арбузное мороженое это десерт" ?newcf)))
)
...
(defrule r157-fact-exists
    ...
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Горячий какао в кастрюле из молока, какао и сахара" ?newcf)))
)
...
(defrule r158-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Горячий какао это напиток" ?newcf)))
)
...
(defrule r159-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.9 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Арбузный сок из арбуза и сахара" ?newcf)))
)
...
(defrule r160-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Арбузный сок это напиток" ?newcf)))
)
...
(defrule r161-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.9 (min ?cf0 ?cf1 ?cf2)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Тыквенный сок из тыквы и моркови и сахара" ?newcf)))
)
...
(defrule r162-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Тыквенный сок это напиток" ?newcf)))
)
...
(defrule r163-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 0.88 (min ?cf0 ?cf1)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Яблочный компот в кастрюле из яблок и сахара" ?newcf)))
)
...
(defrule r164-fact-exists
    ...
    (bind ?newcf (parallel-combination-function (serial-combination-function 1.0 (min ?cf0)) ?cf))
    (modify ?f (certainty-factor ?newcf))
    (assert (sendmessage (str-cat "Яблочный компот это напиток" ?newcf)))
)
